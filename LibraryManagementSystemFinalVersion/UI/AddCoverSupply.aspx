<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Index.Master" AutoEventWireup="true" CodeBehind="AddCoverSupply.aspx.cs" Inherits="LibraryManagementSystemFinalVersion.UI.AddCoverSupply" %>
<asp:Content ID="Content2" ContentPlaceHolderID="middleContentPlaceHolder" runat="server">
    <form runat="server">
        <div class="customize">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <div class="panel-title">Cover Supply Entry Form</div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group pull-right">
                                <input type="text" name="supplyTextBox" id="supplyTextBox" runat="server" class="form-control" placeholder="SupplyNo Here" />
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label2" runat="server" Text="Supply No" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
                            <asp:TextBox ID="supplyNoTextBox" runat="server" class="form-control"></asp:TextBox><br />
                        </div>
                    </div>
