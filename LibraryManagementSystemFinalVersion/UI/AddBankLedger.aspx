<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Index.Master" AutoEventWireup="true" CodeBehind="AddBankLedger.aspx.cs" Inherits="LibraryManagementSystemFinalVersion.UI.AddBankLedger" %>
<asp:Content ID="Content2" ContentPlaceHolderID="middleContentPlaceHolder" runat="server">
    <form runat="server">
        <div class="customize">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <div class="panel-title">Bank Statement</div>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label4" runat="server" Text="Bank Name" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
