<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Index.Master" AutoEventWireup="true" CodeBehind="AddBookReject.aspx.cs" Inherits="LibraryManagementSystemFinalVersion.UI.AddBookReject" %>
<asp:Content ID="Content2" ContentPlaceHolderID="middleContentPlaceHolder" runat="server">
    <form runat="server">
        <div class="customize">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <div class="panel-title">Book Reject Entry Form</div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group pull-right">
                                <input type="text" name="rejectTextBox" id="rejectTextBox" runat="server" class="form-control" placeholder="RejectNo Here" />
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label2" runat="server" Text="Reject No" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
                            <asp:TextBox ID="rejectNoTextBox" runat="server" class="form-control"></asp:TextBox><br />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label5" runat="server" Text="Reject Rate" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
                            <asp:TextBox ID="rejectRateTextBox" runat="server" class="form-control"></asp:TextBox><br />
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("[id$='quantityTextBox']").blur(function () {
                ...
                var rejectRate = $("[id$='rejectRateTextBox']").val();
                if (rejectRate == "") rejectRate = 0;
                var result = quantity * rejectRate;
