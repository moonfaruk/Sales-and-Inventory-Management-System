<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Index.Master" AutoEventWireup="true" CodeBehind="AddBinder.aspx.cs" Inherits="LibraryManagementSystemFinalVersion.UI.AddBinder" %>
        ...
        <div class="customize">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <div class="panel-title">Binder Entry Form</div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group pull-right">
                                <input type="text" name="bTextBox" id="bTextBox" runat="server" class="form-control" placeholder="BinderCode Here" />
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label3" runat="server" Text="Binder Code" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
                            <asp:TextBox ID="binderCodeTextBox" runat="server" class="form-control"></asp:TextBox><br />
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="Label4" runat="server" Text="Binder Name" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
                            <asp:TextBox ID="binderNameTextBox" runat="server" class="form-control"></asp:TextBox><br />
                        </div>
                    </div>

                    <div class="form-group">
                        <asp:Label ID="Label6" runat="server" Text="Binder Address" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
                            <textarea id="binderAddressTextArea" cols="20" rows="3" runat="server" class="form-control"></textarea><br />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <asp:TextBox ID="binderOpeningBalanceTextBox" runat="server" class="form-control"></asp:TextBox><br />
                        </div>
                    </div>
