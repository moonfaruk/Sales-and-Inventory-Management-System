<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Index.Master" AutoEventWireup="true" CodeBehind="AddBinderOrder.aspx.cs" Inherits="LibraryManagementSystemFinalVersion.UI.AddBinderOrder" %>
<asp:Content ID="Content2" ContentPlaceHolderID="middleContentPlaceHolder" runat="server">
     <form runat="server">
        <div class="customize">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <div class="panel-title">Binder Order Entry Form</div>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label4" runat="server" Text="Order No." class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <asp:Label ID="Label1" runat="server" Text="Group Code" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
                            <asp:DropDownList ID="groupCodeDropDownList" runat="server" class="form-control"></asp:DropDownList><br />
                        </div>
                    </div>  
                     <div class="form-group">
                        <asp:Label ID="Label7" runat="server" Text="Book Code" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
                            <asp:DropDownList ID="bookCodeDropDownList" runat="server" class="form-control"></asp:DropDownList><br />
                        </div>
                    </div> 
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label2" runat="server" Text="Forma Quantity" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
                            <asp:TextBox ID="formaQuantityTextBox" runat="server" class="form-control"></asp:TextBox><br />
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="Label5" runat="server" Text="Press Name" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
                            <asp:DropDownList ID="pressNameDropDownList" runat="server" class="form-control"></asp:DropDownList><br />
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label ID="Label6" runat="server" Text="Forma" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
