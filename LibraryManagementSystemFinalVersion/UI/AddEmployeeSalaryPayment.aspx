<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Index.Master" AutoEventWireup="true" CodeBehind="AddEmployeeSalaryPayment.aspx.cs" Inherits="LibraryManagementSystemFinalVersion.UI.AddEmployeeSalaryPayment" %>
<asp:Content ID="Content2" ContentPlaceHolderID="middleContentPlaceHolder" runat="server">
     <form runat="server">
        <div class="customize">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <div class="panel-title">Employee Salary/Extra Payment</div>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <asp:Label ID="Label3" runat="server" Text="Payment Mode" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
                     ...
                     <div class="form-group">
                        <asp:Label ID="Label8" runat="server" Text="Bank Name" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label6" runat="server" Text="Check Date" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
                            <div class="input-group">
