<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Index.Master" AutoEventWireup="true" CodeBehind="AddOtherBillPayment.aspx.cs" Inherits="LibraryManagementSystemFinalVersion.UI.AddOtherBillPayment" %>
<asp:Content ID="Content2" ContentPlaceHolderID="middleContentPlaceHolder" runat="server">
    <form runat="server">
        <div class="customize">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <div class="panel-title">Others Payment</div>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label4" runat="server" Text="Exp. Head" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
                            <asp:DropDownList ID="expHeadDropDownList" runat="server" class="form-control"></asp:DropDownList><br />
                        </div>
                    </div>    
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label6" runat="server" Text="Remarks" class="col-sm-4 control-label"></asp:Label>
                        <div class="col-sm-6">
